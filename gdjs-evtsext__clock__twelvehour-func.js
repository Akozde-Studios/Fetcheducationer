...
gdjs.evtsExt__Clock__TwelveHour.userFunc0x1692eb0 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
const d = new Date();
var hour = d.getHours();
...
const objects = [];
gdjs.evtsExt__Clock__TwelveHour.userFunc0x1692eb0(runtimeScene, objects, eventsFunctionContext);
